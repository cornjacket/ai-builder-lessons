# Lesson 010 — Inject Outputs, Not Inputs
...
- [005 — Abstract Test Infrastructure for Local vs CI](005-abstract-test-infrastructure-for-local-vs-ci.md): The `testutil` layer that provides real infrastructure for component test inputs.
- [008 — Integration Tests Should Own Their Schema Lifecycle](008-integration-tests-own-schema-lifecycle.md): Schema management for tests that use real databases.
