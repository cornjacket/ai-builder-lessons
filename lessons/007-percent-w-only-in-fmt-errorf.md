# Lesson 007 — `%w` Only Works in `fmt.Errorf`
...
- [006 — Explicit Milestone Tags in Checklists](006-explicit-milestone-tags-in-checklists.md): Both lessons illustrate things that "work fine now" but break under CI scrutiny.
