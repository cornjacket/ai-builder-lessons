# Lesson 011 — Sentinel Event Pattern for Negative Assertions
...
- [010 — Inject Outputs, Not Inputs](010-inject-outputs-not-inputs.md): The output injection pattern that makes channel-based mocks possible in component tests.
- [008 — Integration Tests Should Own Their Schema Lifecycle](008-integration-tests-own-schema-lifecycle.md): Infrastructure setup patterns for tests that use real message buses.
