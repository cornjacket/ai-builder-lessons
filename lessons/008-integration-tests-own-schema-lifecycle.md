# Lesson 008 — Integration Tests Should Own Their Schema Lifecycle
...
- [005 — Abstract Test Infrastructure for Local vs CI](005-abstract-test-infrastructure-for-local-vs-ci.md): The `testutil` abstraction layer where the drop/migrate logic lives.
- [007 — %w Only Works in fmt.Errorf](007-percent-w-only-in-fmt-errorf.md): Discovered in the same test helper code.
