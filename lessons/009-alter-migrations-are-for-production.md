# Lesson 009 — ALTER Migrations Are for Production, Not Pre-Production
...
- [008 — Integration Tests Should Own Their Schema Lifecycle](008-integration-tests-own-schema-lifecycle.md): The testing issue that surfaced this migration problem.
